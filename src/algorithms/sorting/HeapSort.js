...
const HeapSort = (nums) => {
  ...
  const left = (i) => 2 * i + 1;
  const right = (i) => 2 * i + 2;
  const parent = (i) => Math.floor((i - i) / 2);
  ...
  description: (
    <div>
      <p>
        ...
        minimum element. It is in an in-place sorting algorithm that is not
      ...
      <p>
        ...
        the objects have been removed from the heap, the result is a sorted
        array.
      </p>
      <ol>
        <li>
          Call the buildMaxHeap() function on the list. Also referred to as
          heapify(), this builds a heap from the list in O(n) operations.
        </li>
        <li>
        ...
        <li>
          ...
          function on the list to sift the new first element to it's appropiate
          index in the heap.
        </li>
        <li>
